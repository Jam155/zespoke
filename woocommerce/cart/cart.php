				...
				<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<td class="product-quantity" data-title="<?php _e( 'Quantity', 'woocommerce' ); ?>">
						...
						?>
							...
							<?php $cartrrp = WC()->cart->cart_item_rrp($cart_item_key); /**get_cart_item_rrp($cart_item_key);**/ ?>
							<?php $cartsale = WC()->cart->cart_item_sale($cart_item_key); /*get_cart_item_sale($cart_item_key);*/ ?>
							<?php $saving = WC()->cart->cart_item_saving($cart_item_key); /*get_cart_item_saving($cart_item_key);*/ ?>
	...
	<div class="small-12 medium-12 large-12 columns cart-delivery">
		<div class="row nopadding">
			<div class="small-12 medium-6 large-3 columns">
				...
				<p><?php echo get_field('delivery_checkout', 'options'); /*_e("UK and Ireland FREE Delivery");*/ ?></p>
			</div>
			<div class="small-12 medium-6 large-5 columns">
				<?php woocommerce_shipping_calculator(); ?>
			</div>
			<div class="medium-12 large-4 columns delivery-extra-info">
				<p>Deliveries will be made between 7:30am and 9:00pm, Monday through Friday, excluding weekends and bank holidays.</p>
			</div>
		</div>
	</div>
